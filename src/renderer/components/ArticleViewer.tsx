...
export function ArticleViewer({ html, isLoading, version }: ArticleViewerProps): JSX.Element {
  if (isLoading) {
    return (
      <div className="flex h-full items-center justify-center rounded-2xl border border-zinc-900 bg-forge-card">
        <div className="text-center">
          ...
          <p className="mt-4 font-display uppercase tracking-[0.2em] text-forge-text">Loading article</p>
        </div>
      </div>
    );
  }
